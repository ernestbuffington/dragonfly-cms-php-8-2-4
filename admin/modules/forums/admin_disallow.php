 ...
 *
 *	 $Id: admin_disallow.php,v 9.3 2005/10/11 12:31:44 djmaze Exp $
 *
 *
 ***************************************************************************/
/***************************************************************************
...
if( isset($_POST['add_name']) )
{
	...
	$message .= "<br /><br />" . sprintf($lang['Click_return_disallowadmin'], "<a href=\"".adminlink("&amp;do=disallow")."\">", "</a>") . "<br /><br />" . sprintf($lang['Click_return_admin_index'], "<a href=\"".adminlink($op)."\">", "</a>");
...
else if( isset($_POST['delete_name']) )
{
	...
	$message .= $lang['Disallowed_deleted'] . "<br /><br />" . sprintf($lang['Click_return_disallowadmin'], "<a href=\"".adminlink("&amp;do=disallow")."\">", "</a>") . "<br /><br />" . sprintf($lang['Click_return_admin_index'], "<a href=\"".adminlink($op)."\">", "</a>");
...
$template->assign_vars(array(
	...
	"S_FORM_ACTION" => adminlink("&amp;do=disallow"),
