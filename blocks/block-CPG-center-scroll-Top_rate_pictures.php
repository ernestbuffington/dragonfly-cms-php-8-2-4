...
/*********************************************
  ...
  ********************************************
  ...
  $Source: /public_html/blocks/block-CPG-center-scroll-Top_rate_pictures.php,v $
  $Revision: 9.8 $
  $Author: djmaze $
...
$content .= '<table width="100%" cols="' . $length . '" border="0" cellpadding="0" cellspacing="7" align="center"><tr>'; // END USER DEFINABLES
// modified by DJMaze
...
$content .= '</tr></table></marquee><table width="100%" border="0" cellpadding="0" cellspacing="0" align="center"><tr align="center"><td valign="baseline"><a href="' . getlink($cpg_dir) . '">' . _coppermineLANG . '</a><br /></td></tr></table></p>';
