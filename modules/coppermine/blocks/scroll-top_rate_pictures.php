...
$pic = 0;
$content = '<div style="text-align:center;"><a name="scroller"></a><marquee loop="1" behavior="scroll" direction="up" height="150" scrollamount="1" scrolldelay="1" onmouseover=\'this.stop()\' onmouseout=\'this.start()\'><center>';
...
$content .= '</marquee><p><a href="'. URL::index($cpg_dir) . '">'._coppermineLANG.'</a></p></div>';
