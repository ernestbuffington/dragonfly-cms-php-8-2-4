...
$content = '<div style="text-align:center;"><a name="scroller"></a><marquee loop="0" behavior="scroll" direction="left" height="125" width="80%" scrollamount="2" scrolldelay="1" onmouseover=\'this.stop()\' onmouseout=\'this.start()\'><table><tr align="center">';
while ($row = $result->fetch_assoc()) {
	...
	$content .= '<td align="center" valign="baseline"><a href="' .htmlspecialchars($CPG->getImageUrl($row)). '"><img src="' . $CPG->getPicSrc($row, 'thumb') . '" alt="' . $thumb_title . '" title="' . $thumb_title . '" /><br />' . Coppermine::truncateString($thumb_title, 12) . '</a></td>';
}
$content .= '</tr></table></marquee></div><p style="text-align:center;"><table><tr align="center"><td valign="baseline"><a href="' . URL::index($cpg_dir) . '">' . _coppermineLANG . '</a><br /></td></tr></table></p>';
