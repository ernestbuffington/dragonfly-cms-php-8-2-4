...
/*********************************************
  ...
  ********************************************
  ...
  $Source: /public_html/language/english/news.php,v $
  $Revision: 9.7 $
  $Author: djmaze $
  $Date: 2005/12/23 15:22:03 $
Encoding test: n-array summation ∑ latin ae w/ acute ǽ
*******************************************************/
if (!defined('CPG_NUKE')) { exit; }
//moved to main.php define('_PRINTER','Printer Friendly Page');
...
define('_NOANONCOMMENTS','No Comments Allowed for Anonymous, please <a href="'.getlink("Your_Account&amp;file=register").'">register</a>');
