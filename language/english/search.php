...
/*********************************************
  ...
  ********************************************
  ...
  $Source: /public_html/language/english/search.php,v $
  $Revision: 9.5 $
  $Author: phoenix $
  $Date: 2007/08/28 05:37:45 $
...
define('_SEARCHONLYIN','Search only in these areas:');
define('_ADVOPTIONSFOR', 'Advanced search options for');
