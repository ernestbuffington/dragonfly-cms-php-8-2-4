...
abstract class QRUtil {
	...
	{
		$d = $data << 10;
		while (static::getBCHDigit($d) - static::getBCHDigit(self::G15) >= 0) {
			$d ^= (self::G15 << (static::getBCHDigit($d) - static::getBCHDigit(self::G15)));
		}
	...
	{
		$d = $data << 12;
		while (static::getBCHDigit($d) - static::getBCHDigit(self::G18) >= 0) {
			$d ^= (self::G18 << (static::getBCHDigit($d) - static::getBCHDigit(self::G18)));
		}
		return ($data << 12) | $d;
	}
