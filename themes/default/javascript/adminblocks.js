var Tack = {
	...
	hover : function(o){
		if (!Tack.src && o) {
			o.style.cursor = 'move';
			o.style.cursor = 'url(themes/default/images/cursors/grab.cur), move';
	...
	start : function(e,o) {
		if (!Tack.src || !Tack.ft) {
			...
			o.style.cursor = 'move';
			o.style.cursor = 'url(themes/default/images/cursors/grabbing.cur), move';
	...
	drag : function(e)
	{
		...
		if (Tack.src && Tack.ft) {
			...
			Tack.ft.firstChild.style.cursor = 'url(themes/default/images/cursors/grab.cur), move';
		...
		if (!Block.src && o) {
			if (o.nodeName.toLowerCase() == 'td') {
				if (Block.accept) {
					...
					o.style.cursor = 'url(themes/default/images/cursors/copy.cur), move';
	...
	start : function(e,o) {
		if (!Block.src || !Block.ft) {
			...
			if (Block.accept && Block.root) {
				...
				//Block.ft.style.cursor = 'url(themes/default/images/cursors/grabbing.cur), move';
